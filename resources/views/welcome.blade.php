            ...
            <div class="container mx-auto p-6">
                <section class="mb-12">
                    <div class="bg-dark-500 dark:bg-gray-800 shadow-md rounded-lg p-6 flex flex-col items-center">
                        ...
                        <p class="text-gray-700 dark:text-gray-300 text-center font-semibold mb-6">
                            En Cinemain, te ofrecemos reseñas, noticias y recomendaciones de las últimas películas y
                            series. ¡Explora nuestro contenido y encuentra tu próxima maratón!
                        </p>
