        ...
        axios
            ...
            .then((response) => {
                ...
                const firstAirDate = serieDetails.first_air_date
                    ...
                    : "";
                document.getElementById("anio").value = firstAirDate;
                ...
                if (directors.length > 0) {
                    ...
                    for (let option of directorSelect.options) {
                        if (option.text === directors[0].name) {
                            directorSelect.value = option.value;
                            break;
                        }
                    }
                }
