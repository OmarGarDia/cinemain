...
Route::middleware(['auth', 'checkRole:1'])->group(function () {
    ...
    Route::delete('/movies/{pelicula}/actor/{actor}', [PeliculasController::class, 'deleteActorFromMovie'])->name('delete_actor_from_movie');
    ...
    Route::delete('/series/delete/{serie}', [SeriesController::class, 'destroy'])->name('deleteserie');
